...
<section class="publicMian ">
    <div class="left">
        ...
        <nav>
            <ul class="list">
                <li ><a href="${pageContext.request.contextPath}/pages/billList.html">账单管理</a></li>
                <li><a href="${pageContext.request.contextPath}/pages/providerList.html">供应商管理</a></li>
                <li><a href="${pageContext.request.contextPath}/servlet/loginServlet?action=list">用户管理</a></li>
                <li id="active"><a href="${pageContext.request.contextPath}/servlet/loginServlet?action=upwd">密码修改</a></li>
