...
public class Blog {
    ...
    public static void main(String[] args) {
        JSONObject jsonObject = jsonMaker(1);
        String s = SendPostCnBlog("http://www.cnblogs.com/mvc/AggSite/PostList.aspx", jsonObject);
        ArrayList<Cnblog> blogs = GetContens(s);
    }
}
